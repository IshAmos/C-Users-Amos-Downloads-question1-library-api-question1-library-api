...
✅ Sample data pre-loaded in all controllers  
...
- **Students:** 5 sample students (3 with CS major, GPA >= 3.7)
- **Menu Items:** 8 items across all categories (Appetizer, Main Course, Dessert, Beverage)
- **Products:** 10 products across multiple categories/brands
- **Tasks:** 5 tasks with different priorities
- **Users:** 5 users from different countries
...
- All data is stored in-memory (ArrayList) for simplicity
- No database is used (as per assignment requirements)
- Each controller initializes sample data in its constructor

---

**Submission:** Pushed to GitHub on branch `restFull_api_26247`
